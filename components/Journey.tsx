...
const journeyItems: JourneyItem[] = [
  {
    ...
    description: 'Building NLP pipelines with LangExtract, ViT-based classification models with diffusion augmentation, and multi-agent RAG systems for real-time stock forecasting.',
  ...
  },
  {
    ...
    subtitle: 'University of Illinois Chicago',
    description: 'Pursuing advanced studies in Machine Learning, NLP, AI Systems, and Computer Vision.',
  ...
  },
  {
    ...
    subtitle: '24/7.ai',
    description: 'Led production ML initiatives — deployed CLIP-based compliance monitoring (40% QA reduction), GPT-powered RAG agent assist (25% FCR improvement), and owned 50+ models at 99.7% uptime.',
  ...
  },
  {
    ...
    description: 'Graduated with focus on ML and Computer Vision. Built real-time object detection and NLP sentiment analysis systems.',
    icon: <GraduationCap className="w-5 h-5" />,
    highlight: 'GPA: 3.4/4.0',
  },
  {
    year: '2020',
    title: 'Started Career at 24/7.ai',
    subtitle: 'Data Scientist',
    description: 'Joined as Data Scientist building conversational AI triage systems, vector-based agent routing with Pinecone + Neo4j, and BiLSTM/CNN models for real-time sentiment analysis.',
